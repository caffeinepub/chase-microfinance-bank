...
export class Backend implements backendInterface {
    ...
    async getUserByName(arg0: string): Promise<User> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserByName(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listUsersById(): Promise<Array<User>> {
        if (this.processError) {
            try {
                const result = await this.actor.listUsersById();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listUsersByName(): Promise<Array<User>> {
        if (this.processError) {
            try {
                const result = await this.actor.listUsersByName();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
